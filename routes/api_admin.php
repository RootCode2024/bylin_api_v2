...
Route::prefix('v1/admin')
    ...
    ->group(function () {
        ...
        Route::get('collections-seasons', [\Modules\Catalogue\Http\Controllers\Admin\CollectionController::class, 'seasons'])
            ->name('collections.seasons');
        Route::get('collections-featured', [\Modules\Catalogue\Http\Controllers\Admin\CollectionController::class, 'featured'])
